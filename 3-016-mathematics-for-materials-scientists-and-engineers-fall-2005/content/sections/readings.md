...
menu:
  leftnav:
    identifier: 9fc888981a4a889a8dce547f7131f69a
    name: Readings
    weight: 30
title: Readings
type: course
uid: 9fc888981a4a889a8dce547f7131f69a
...
| L2 | Introduction to Mathematica®, Assignment and Evaluation, Rules and Replacement, Procedural and Functional Programming | [Lecture notes]({{< baseurl >}}/sections/lecture-notes) and Mathematica® notebook. |
| Lab 1 | Getting Started with Mathematica® | _Mathematica® Help Browser  {{< br >}}_Online Tutorial |
...
| Lab 2 | Symbolic Calculations and Plotting | _Mathematica® Help Browser  {{< br >}}_Kreyszig and Norminton: sections 1.4.2, 1.7.1.  {{< br >}}Functions: Integrate, Simplify, NIntegrate, Plot, Plot3D, ContourPlot. |
...
| Lab 3 | Solving Linear Systems of Equations | _Mathematica® Help Browser  {{< br >}}_Kreyszig and Norminton: section 1.8.3.  {{< br >}}Functions: Inverse, Transpose, Eigensystem, Matrix Multiplication. |
| {{< td-colspan 3 >}}**[3.014](/courses/3-014-materials-laboratory-fall-2006/sections/labs) Lab Week 1; 3.016 does not meet.**{{< /td-colspan >}} |||
...
| Lab 4 | File Input/Output, Plotting Data | _Mathematica® Help Browser  {{< br >}}_Kreyszig and Norminton 2.12.7, 2.12.8.  {{< br >}}Functions: Dimensions, Append, AppendTo, Do, Mean, Standard Deviation, ListPlot, Table, Graphics 'MultipleListPlot, Fit. |
...
| Lab 5 | Statistics, Fitting Data, Error Analysis | _Mathematica® Help Browser  {{< br >}}_Kreyszig and Norminton: 3.8.2.  {{< br >}}Functions: Fit, FindFit; Package: Statistics 'NonlinearFit. |
